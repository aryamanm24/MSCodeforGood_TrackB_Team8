...
export default function MapView({
  ...
  useEffect(() => {
    ...
    // Expose invalidateSize so parent can call after CSS transition
    if (onInvalidateRef) {
      onInvalidateRef(() => {
    ...
    resources.forEach((r) => {
      ...
      const icon = L.divIcon({
        ...
        html: `<div style="
          ...
          box-shadow:${isActive ? `0 0 0 5px ${color}30, 0 2px 8px rgba(0,0,0,.2)` : "0 1px 3px rgba(0,0,0,.15)"};
